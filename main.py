...
origins = [
    ...
    "http://localhost","http://localhost:8080","https://localhost:8080",
     "https://cajero-app2.herokuapp.com", "http://cajero-app2.herokuapp.com",
     "https://appherokucajero.herokuapp.com/"
]
